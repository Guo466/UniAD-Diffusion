...
class PointsEncoder(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        if os.getenv("DEPLOY") != 'True':
            ...
            x_features = x_features * mask_value
