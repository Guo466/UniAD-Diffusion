...
try:
    ...
    from datasets.diffusion_dataset_ego_navi import DiffusionDataset
...
class DiffusionModelVisualizer:
    ...
    def process_single_frame(self, test_data: Any, frame_idx: int, 
        ...
        pred_trajs_tensor= self.model.model.sample(model_input,input_noise,sample_steps=5)
...
def main():
    ...
    #     model_checkpoint = "/iag_ad_01/ad/mayicheng/860_min2_new_method_ego_navi_plus_ego_routing_hs256_bs192_lr1e-3_epoch40_n4_lr0.001_bs192/epoch=35-val_loss=0.0171.ckpt",
    #     device = "cpu"
    # )
    
    # final_fig = visualizer.run_pipeline(
    #     test_data_dir = "/iag_ad_01/ad/yanghang2/ld/ld_v6_val_vsd/cache_ld_v6_val_vsd/turn_left/2025_07_05_16_31_26",
    #     start_idx = 0,
    #     horizon = 10,
    #     show_plot = True
    # )
